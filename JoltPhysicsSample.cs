...
public abstract class JoltPhysicsSample : IDisposable
{
    ...
    public Body CreateBox(in Vector3 halfExtent,
        in Vector3 position,
    ...
    public Body CreateSphere(float radius,
        in Vector3 position,
        in Quaternion rotation,
        MotionType motionType,
        ObjectLayer layer,
